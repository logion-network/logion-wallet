...
const CSV_WITHOUT_FILE = new File([`ID,DESCRIPTION
1,An NFT ID
2,Another NFT ID
`], "items.csv");

const CSV_WITHOUT_FILE_EMPTY_ROWS = new File([`ID,DESCRIPTION
1,An NFT ID
...
const CSV_WITH_FILE = new File([`ID,DESCRIPTION,FILE NAME,FILE CONTENT TYPE,FILE SIZE,FILE HASH
programming_music.jpg,Programming Music,programming_music.jpg,image/jpeg,90718,0xa025ca5f086f3b6df1ca96c235c4daff57083bbd4c9320a3013e787849f9fffa
lucas_games_characters.jpg,LucasArts Games Characters,lucas_games_characters.jpg,image/jpeg,91880,0x546b3a31d340681f4c80d84ab317bbd85870e340d3c2feb24d0aceddf6f2fd3
`], "items.csv");
