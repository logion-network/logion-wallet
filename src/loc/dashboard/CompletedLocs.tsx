...
export default function CompletedLocs(props: Props) {
    ...
    const columns = useMemo(() => {
        ...
        return result.concat([
            ...
            {
                header: "Status",
                render: locData => <LocStatusCell status={ locData.status } voidLoc={ locData.voidInfo !== undefined }/>,
                width: "140px",
            },
            {
                header: "Closing date",
    ...
    return (
        <Table
            ...
            renderEmpty={ () => <EmptyTableMessage>No completed LOC yet</EmptyTableMessage> }
        />
    );
}
