...
import type { AccountId, AssetId, Balance, BlockNumber, Call, ChangesTrieConfiguration, KeyValue, LookupSource, Moment, OpaqueCall, Perbill, Weight } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    vault: {
       ...
       **/
      approveCall: AugmentedSubmittable<(otherSignatories: Vec<AccountId> | (AccountId | string | Uint8Array)[], call: OpaqueCall | string | Uint8Array, timepoint: Timepoint | { height?: any; index?: any } | string | Uint8Array, maxWeight: Weight | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<AccountId>, OpaqueCall, Timepoint, Weight]>;
      /**
       * Create a vault transfer. The creator must not be a legal officer.
       **/
      requestCall: AugmentedSubmittable<(legalOfficers: Vec<AccountId> | (AccountId | string | Uint8Array)[], callHash: U8aFixed | string | Uint8Array, maxWeight: Weight | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<AccountId>, U8aFixed, Weight]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
